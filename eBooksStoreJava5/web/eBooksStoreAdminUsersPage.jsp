                ...
                <form action="${pageContext.request.contextPath}/eBooksStoreAdminUsersServlet" method="POST">
                    ...
                    <table border="1" width="100%">
                        <tr>
                            ...
                            <th width="14%" class="thc"> SSN </th>  
                            <th width="14%" class="thc">NAME</th>
                            <th width="14%" class="thc">PASSWORD</th>
                            <th width="14%" class="thc">ROLE <input type="submit" name="admin_userroles_open" value="Admin"></th>
                        </tr>                        
