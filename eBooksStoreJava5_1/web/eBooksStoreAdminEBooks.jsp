            ...
            <c:when test="${validUser == true}">   
                ...
                <form action="${pageContext.request.contextPath}/eBooksStoreAdminEBooks" method="POST">
                    ...
                    <sql:setDataSource 
                        ...
                        user="test"  
                        password="test"/>
                    <sql:query dataSource="${snapshottypes}" var="resultauthors">
                    ...
                    <sql:query dataSource="${snapshottypes}" var="resultqualities">
                        SELECT QUALITY FROM EBOOKS.BOOK_PAPER_QUALITIES ORDER BY QUALITY ASC 
                    </sql:query>
                    <sql:query dataSource="${snapshottypes}" var="resultgenres">
                        SELECT GENRE FROM EBOOKS.BOOK_GENRES ORDER BY GENRE ASC 
                    </sql:query>
                            ...
                            <td>    
                                <table>
                                    ...
                                    <tr>
                                        <td> AUTHOR: </td>
                                        <td>
                                            <select name="admin_ebooks_author" required="true">
                                                <c:forEach var="rowauthor" items="${resultauthors.rows}">    
                                                    <option name="admin_ebooks_authors" value="${rowauthor.ssn}">${rowauthor.first_name}&nbsp${rowauthor.family_name}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                    </tr>
